...
class iOSViewControllerFactory:ViewControllerFactory{
    ...
    init(questions:[Question<String>],
         ...
         correctAnswers:Dictionary<Question<String>,Set<String>>
    ) {
    ...
    func resultViewController(for result: QuizEngine.Result<Question<String>,Set<String>>) -> UIViewController {
